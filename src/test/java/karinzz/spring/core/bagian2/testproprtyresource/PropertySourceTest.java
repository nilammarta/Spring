package karinzz.spring.core.bagian2.testproprtyresource;
...
// karena sumber resources nya berada di dalam folder test maka kita perlu menggunakan @TestPropertySource
@TestPropertySources({
